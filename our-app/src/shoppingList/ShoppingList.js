...
class ShoppingList extends Component {
  ...
  componentDidMount() {
    //Read from local storage on init component render
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    // Save data to local storage on every component update

    const prevStateSting = JSON.stringify(prevState.groceryItems)
